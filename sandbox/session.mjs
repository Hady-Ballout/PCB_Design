 ...
 *
 * @param {{ prompt: string, id?: string, assertions?: string[], owner?: number }} options
 */
export const create = ({ prompt, id, assertions = [], owner }) => {
  ...
  writeSession(workspace, {
    ...
    prompt,
    assertions,
    // Which user the run belongs to; absent for CLI/eval runs, enforced by the
    // HTTP layer when present.
 ...
 * @param {{ maxTurns?: number, abortController?: AbortController }} [options]
 */
